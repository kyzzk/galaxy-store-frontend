    ...
    <div className={`${styles.homeContainer} ${styles.container}`}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.loginBox}>
          ...
          <a href="https://discord.com/oauth2/authorize?client_id=1128729319590608966&redirect_uri=https%3A%2F%2Fwww.galaxystore.shop%2F&response_type=code&scope=identify%20email">
